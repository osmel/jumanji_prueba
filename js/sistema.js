...
jQuery("#form_recuperar").submit(function(e){
		jQuery('#foo').css('display','block');
...
var hash_url = window.location.pathname;
	...
	if ( (hash_url=="/juegos")   && (typeof(localStorage.getItem('inicioJuego')) != "undefined")  &&  ((localStorage.getItem('inicioJuego')) == "1")  ) { //registro ticket
      
                        jQuery('#botonParar').css('display','block');
             
		jQuery('button#botonIniciar').css('display','none');
