		...
		<div class="container intro" style="">
			...
			<div class="row">								
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="row">
						<div class="ganar col-lg-12 col-md-12 col-sm-12 col-xs-12 siniz">
							<img src="<?php echo base_url()?>img/liga.png" class="img-responsive">
             ...
             <?php }else{ ?>
					<div class="col-md-6 text-center">
								<a href="<?php echo base_url()?>registro_usuario" class="ingresarhome">NO TENGO CUENTA</a>
							</div>
							<div class="col-md-6 text-center">								
								<a href="<?php echo base_url(); ?>ingresar_usuario" class="ingresarhome">INGRESAR</a>
							</div>
             <?php } ?> 
