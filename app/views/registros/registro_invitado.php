...
<div class="form-group">
				...
				<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
					...
					<input value="<?php echo $jefe_equipo->id; ?>" type="hidden" class="form-control" id="id" name="id">
						...
						<fieldset disabled>
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<label for="email" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 control-label">Correo electrónico:</label>
									<input value="<?php echo $jefe_equipo->email_invitado; ?>"  type="email" class="form-control" id="email" name="email">
