	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">				
				<h2 class="text-center">Escriba su correo</h2>
			</div>
		</div>
		...
		<div class="row">			
			<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-12">
				<div class="formulario-fondos">
					<?php echo form_open('/validar_recuperar_invitado', array( 'id' => 'form_recuperar', 'name' => $retorno, 'class' => 'form-horizontal', 'method' => 'POST', 'autocomplete' => 'off', 'role' => 'form' ) ); ?>
						
						<div class="col-lg-12">
							<p>Ingresa tu correo electrónico para recuperar su invitación</p>
						</div>
