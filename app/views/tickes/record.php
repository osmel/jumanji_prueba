...
<div class="row">
	...
	<div class="">								
		<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 col-xs-12 mimarcador transparenciaformularios">
			...
			<p class="datos"><span class="textosdatos">PUNTOS OBTENIDOS DEL JUEGO: </span><span><?php echo $record->total_iguales+$record->total_desiguales; ?></span></p>
			...
			<p class="datos"><span class="textosdatos">TOTAL DE PUNTOS ACUMULADOS: </span><span><?php echo ($record->total_iguales+$record->total_desiguales)+$record->transaccion+$record->ptoface; ?></span></p>
