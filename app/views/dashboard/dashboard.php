...
?>	
			...
			<div class="container home">								
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center mecans" style="margin-top:0px !important">
							<img src="<?php echo base_url()?>img/home3.png" style="width:50%;" class="">
							<img src="<?php echo base_url()?>img/home2a.png" style="max-width:auto" class="">
							<!-- <img src="<?php echo base_url()?>img/lateralizquierdo.png" class="img-responsive sinizquierdo">
				             ...
				             <?php }else{ ?>
											...
											<div class="col-lg-12 col-md-12 col-xs-12 text-center oscultar2">								
												<!-- <a href="<?php echo base_url(); ?>ingresar_usuario" ><img src="<?php echo base_url(); ?>img/login.png"></a>
												 --><img src="<?php echo base_url(); ?>img/image001.png">
											</div>
											<!-- <div class="col-lg-6 col-md-6 col-xs-12 text-center oscultar2">
												<a href="<?php echo base_url()?>registro_usuario" ><img src="<?php echo base_url(); ?>img/registrarme1.png"></a>
											</div> -->
				             <?php } ?> 
				             <div class="col-lg-12 col-md-12 text-center" style="clear:both">
